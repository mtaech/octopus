...
export function storybookFallingStar(): Storybook {
  return {
    ...
    characters: [
      { id: 'char-mira', name: '米拉', kind: 'pc', background: '流浪的赏金猎人，为追查一桩旧案来到坠星谷。', personality: '冷静寡言，观察敏锐，习惯先确认退路。', attributes: { str: 55, agi: 70, wit: 75, cha: 45, trait: '多疑', note: '' }, resources: { 'res-gold': 32, 'res-stamina': 100 } },
      { id: 'char-isa', name: '伊莎', kind: 'npc', background: '碎星酒馆老板娘，十年前从王都搬来，消息灵通。', personality: '热情圆滑，话里有话，护短。', attributes: { str: 40, agi: 50, wit: 80, cha: 85, trait: '慷慨', note: '' } },
      { id: 'char-oden', name: '奥登', kind: 'npc', background: '星辰教堂执事，看守地窖，笃信星象。', personality: '温和谨慎，忌讳谈论流星。', attributes: { str: 45, agi: 40, wit: 70, cha: 65, trait: '沉稳', note: '' } },
      { id: 'char-kael', name: '凯尔', kind: 'npc', background: '镇上的年轻铁匠，流星夜后变得焦躁。', personality: '冲动直率，藏不住事。', attributes: { str: 78, agi: 60, wit: 40, cha: 50, trait: '急躁', note: '' } }
    ],
    skills: [
...
export function storybookAsh(): Storybook {
  ...
  return {
    ...
    world: { ...base.world, premise: '旧世界焚毁后，幸存者蜷缩在灰烬城的铁墙后。巡夜人每晚出城，为死在墙外的亡魂点上最后一盏灯。' },
...
export function storybookDraft(): Storybook {
  ...
  return {
    ...
    skeleton: [{ id: 'ch-1', title: '第一章 · 驿站', description: '', scenes: [{ id: 'sc-1', title: '初雪驿站', goals: [{ id: 'g1', text: '把信送到驿站掌柜手上', primary: true, condition: null }], beats: [] }] }],
