...
// 注意：reka-ui 的开关只输出 `data-state="checked|unchecked"`，并不写 data-checked /
// data-unchecked 属性。所以样式必须用 `data-[state=...]:` 这种写法——写成裸 data 变体
// （data-checked:bg-primary）会匹配不到，轨道背景直接是透明的，开关看起来像「消失了」。
</script>
