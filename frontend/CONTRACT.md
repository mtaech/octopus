...
- 页面三个 stub 已挂路由：src/pages/list/ListPage.vue、src/pages/editor/EditorPage.vue、src/pages/play/PlayPage.vue。**你负责其中一页**，风格参照同仓库 .scratch/ai-rpg/prototypes/*.html（深色、克制、信息密度高）。
